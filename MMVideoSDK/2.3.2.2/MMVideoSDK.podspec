...
Pod::Spec.new do |s|
  ...
  s.source           = { :git => 'https://github.com/cosmos33/MMVideoSDK.git', :tag => '2.3.2.1' }
  ...
  s.dependency 'MMMedia', '~> 2.3.2.1'
  s.dependency 'MMCV', '~> 1.0.16.1'
  s.dependency 'MMXEScene', '~> 1.1.0'
  s.dependency 'GPUImage'
  s.dependency 'MetalPetal', '1.4.2'
  s.dependency 'MMFileService', '1.1.0-hs'
